...
export declare function isParsePathResultLoose<H extends string, P extends IParsePathResultPathInput, N extends IParsePathResultNsInput = EnumParsePathResultNs>(result: IParsePathResult<H, P | string, N | string> | unknown): result is IParsePathResult<H, IParsePathResultPath<P>, IParsePathResultNsInputToEnum<N>>;
