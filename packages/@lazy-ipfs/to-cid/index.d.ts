...
export declare function classCID<C extends ICIDObject = MultiformatsCID>(libCID?: IStaticCID<C> | typeof MultiformatsCID | typeof JsCID | EnumTypeofCID): <T extends ICIDValueInput>(cidInput: T, libCID?: IStaticCID<C> | EnumTypeofCID) => C;
...
export declare function toCID<C extends ICIDObject = ICIDObject>(cid: any, libCID?: IStaticCID<C> | EnumTypeofCID): C;
