...
export declare type IRawJsCID = ITSRequireAtLeastOne<ITSPickExtra<JsCID, 'version' | 'multihash' | 'codec' | 'code', 'multibaseName'>, 'codec' | 'code'>;
...
export declare type IRawJsCIDFake<T extends IRawJsCID = IRawJsCID> = T & {
    [SymbolJsCID]?: true;
};
