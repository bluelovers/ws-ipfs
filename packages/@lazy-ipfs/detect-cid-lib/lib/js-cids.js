...
exports.SymbolJsCID = Symbol.for("@ipld/js-cid/CID" /* EnumTypeofCID.js_cids */);
...
function assertJsCID(cid) {
    if (!isJsCID(cid)) {
        throw (0, err_code_1.default)(new TypeError(`CID is not '${"@ipld/js-cid/CID" /* EnumTypeofCID.js_cids */}'`), {
            input: cid,
        });
    }
}
