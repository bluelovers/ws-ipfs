...
export declare function refIPFS(cid: ICIDValue, ipfs: Pick<IPFS, 'refs'>, timeout?: number, options?: IFetchOptions): Bluebird<import("ipfs-core-types/src/refs").RefsResult>;
