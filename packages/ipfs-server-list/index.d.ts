...
export declare function getIpfsServerList(): Record<"ipfs" | "infura.io" | "cloudflare", IIPFSAddressesLike> & Record<string, IIPFSAddressesLike>;
...
export declare const ipfsServerList: Record<"ipfs" | "infura.io" | "cloudflare", IIPFSAddressesLike> & Record<string, IIPFSAddressesLike>;
